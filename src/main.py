...
from agents.retrieval_agent import query_nasa_images_api, query_nasa_techtransfer_api
from agents.synthesizing_agent import generate_query_with_context
from agents.verifier_agent import verifier_response
...
if user_query:
    tools = ToolNode([query_nasa_images_api, query_nasa_techtransfer_api])
    ...
    graph_builder.add_node("verifier", verifier_response(llm=llm))
    ...
    graph_builder.add_edge("generate_query_with_context", "verifier")
